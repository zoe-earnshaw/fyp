...
for name in process_names:
    ...
    if "signal" in name:
        file_name = "signal"
    outputfile = ROOT.TFile(file_name + "_N-1_" + args.stop_mass + "_" + args.lsp_mass + ".output.root", "recreate")
...
f_signal = ROOT.TFile("signal_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
f_W = ROOT.TFile("W_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
f_Z = ROOT.TFile("Z_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
f_top = ROOT.TFile("top_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
f_ttV = ROOT.TFile("ttV_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
f_singletop = ROOT.TFile("singletop_N-1_"+args.stop_mass+"_"+args.lsp_mass+".output.root")
