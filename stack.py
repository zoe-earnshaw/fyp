...
for h_att in h_att_list:
    ...
    for process in processes:
        print(process)
        if process == "signal":
            if ROOT.TFile("/signalpoints/" + process + "_" + args.stop_mass + "_" + args.lsp_mass + ".output.root"):
                print("it exists")
    ...
    c_met.SetLogy()
    c_met.Print("Stack"+h_att.tag+"_"+h_att.hist_name+"_"+args.stop_mass+"_"+args.lsp_mass+".pdf")
